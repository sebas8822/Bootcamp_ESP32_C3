...
& $python3 aws-iot-device-sdk-python-v2\samples\pubsub.py --endpoint a2hb1w86de6tcr-ats.iot.ap-southeast-2.amazonaws.com --ca_file root-CA.crt --cert master_pc_seb.cert.pem --key master_pc_seb.private.key --client_id basicPubSub --topic sdk/test/python --count 0